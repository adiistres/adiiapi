...
var creatorList = ['adiixyz', 'renzy', 'adii renzy'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'chat wa.me/60199782326 to get apikey!!'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid!! chat wa.me/60199782326 to get apikey!!'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'ar') return res.json(loghandler.invalidKey)
